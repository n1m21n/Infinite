...
GROUP_3D=(
  ...
  "MAPPINGSWEEPTEST:10"
  "MATERIALSWEEPTEST:10"
  "TEXTURESWEEPTEST:10"
  "POINTCLOUDSWEEPTEST:10"
  "COLOURSWEEPTEST:10"
  "INSTANCESWEEPTEST:10"
  "CHAINFUZZTEST:15"
...
if [ "$OS" = "Linux" ]; then
  FULL_TESTS+=("MIDIPARSETEST:1" "VST3EDITORSHOTTEST:1" "VST3BLOCKLISTTEST:1")
fi
